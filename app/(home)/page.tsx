...
export default function Home() {
  ...
  Stay ahead of <span className={` italic tracking-tight bg-gradient-to-r from-purple-500 to-purple-900 dark:from-purple-500 dark:to-purple-300 text-transparent bg-clip-text`}>mandates</span> and pitch <span className={`italic tracking-tight bg-gradient-to-r from-purple-500 to-purple-900 dark:from-purple-500 dark:to-purple-300 text-transparent bg-clip-text`}>smarter.</span>
</h1>


              {/* Subtitle */}
              <p className="text-sm md:text-lg text-black/80 dark:text-gray-400 font-sans tracking-tight md:max-w-3xl mx-auto">
                Mandate Wizard tracks real-time opportunities across film, TV, and IP — helping creators and executives
                pitch the right projects to the right people, faster than ever.
              </p>

              <div className="mt-4">
                <Link href="/chat">
                <Button className="rounded-xl bg-[#9747FF]   dark:bg-[#9747FF]">
                  Get Started
                </Button>
                </Link>
              </div>
